...
DATA_FILE = "user_history.json" # 数据存储文件
...
def init_user_data(username):
    ...
    if saved_sessions:
        ...
        st.session_state['current_session_id'] = user_data.get('current_session_id', list(saved_sessions.keys())[0])
    else:
        # 新用户初始化
